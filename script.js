...
form.addEventListener("submit", function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var name, email, phone, address, institution, degree, passingYear, skills, experience, photoFile, photoBase64;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                document.getElementById("displayInstitution").textContent = "".concat(degree, " from ").concat(institution, ", ").concat(passingYear);
